/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/chat/trunk/chat-impl/impl/src/java/org/sakaiproject/chat2/model/impl/ChatRestDelivery.java $
 * $Id: ChatRestDelivery.java 105079 2012-02-24 23:08:11Z ottenhoff@longsight.com $
 ***********************************************************************************
 *
...
public class ChatRestDelivery extends BaseDelivery
{
   ...
   private ContextualUserDisplayService contextualUserDisplayService;
	 ...
	 *        The elementId.
	 */
	public ChatRestDelivery(String address, String elementId, Object message, boolean beepOnDelivery, ChatManager chatManager)
	{
    ...
    * This function happens in the client connection thread instead of in the event notification thread
	...
	public boolean equals(Object obj)
	{
		...
		ChatRestDelivery cob = (ChatRestDelivery) obj;
