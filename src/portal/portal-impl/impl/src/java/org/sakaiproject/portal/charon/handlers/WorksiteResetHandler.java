/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/portal/trunk/portal-impl/impl/src/java/org/sakaiproject/portal/charon/handlers/WorksiteResetHandler.java $
 * $Id: WorksiteResetHandler.java 105079 2012-02-24 23:08:11Z ottenhoff@longsight.com $
 ***********************************************************************************
 *
...
{
	private static final String URL_FRAGMENT = "worksite-reset";

	public WorksiteResetHandler()
	{
		setUrlFragment(WorksiteResetHandler.URL_FRAGMENT);
	}
