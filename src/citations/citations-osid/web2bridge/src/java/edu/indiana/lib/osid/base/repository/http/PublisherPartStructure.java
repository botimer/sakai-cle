...
/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/citations/trunk/citations-osid/web2bridge/src/java/edu/indiana/lib/osid/base/repository/http/PublisherPartStructure.java $
...
public class PublisherPartStructure extends edu.indiana.lib.osid.base.repository.PartStructure
{
    ...
    private boolean repeatable = true;
		...
		protected static PublisherPartStructure getInstance()
		{
    ...
    protected PublisherPartStructure()
    {
        try
        {
            this.PUBLISHER_PART_STRUCTURE_ID =
            	Managers.getIdManager().getId("0bd5374f201080006d751920168000100");
        }
        catch (Throwable t)
        {
        }
