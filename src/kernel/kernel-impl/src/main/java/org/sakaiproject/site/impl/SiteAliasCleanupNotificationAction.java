/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/kernel/trunk/kernel-impl/src/main/java/org/sakaiproject/site/impl/SiteAliasCleanupNotificationAction.java $
 * $Id: SiteAliasCleanupNotificationAction.java 105077 2012-02-24 22:54:29Z ottenhoff@longsight.com $
 ***********************************************************************************
 *
...
public class SiteAliasCleanupNotificationAction implements NotificationAction {
	...
	private static Log log = LogFactory.getLog(SiteAliasCleanupNotificationAction.class);
