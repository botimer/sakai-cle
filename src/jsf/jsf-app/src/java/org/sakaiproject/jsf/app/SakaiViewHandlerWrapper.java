/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/jsf/trunk/jsf-app/src/java/org/sakaiproject/jsf/app/SakaiViewHandlerWrapper.java $
 * $Id: SakaiViewHandlerWrapper.java 128959 2013-08-23 00:01:46Z ottenhoff@longsight.com $
 **********************************************************************************
 *
...
/**
 * <p>
 * SakaiViewHandlerWrapper extends the basic ViewHandlerWrapper functionality
 * 
...
public class SakaiViewHandlerWrapper extends ViewHandlerWrapper
{
	...
	public SakaiViewHandlerWrapper(ViewHandler wrapped) {
		m_wrapped = wrapped;
	...
	{
		return getWrapped().getResourceURL(arg0, arg1);
	}
