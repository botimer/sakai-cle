/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/citations/trunk/citations-osid/xserver/src/java/org/sakaibrary/osid/repository/xserver/CreatorPartStructure.java $
 * $Id: CreatorPartStructure.java 105079 2012-02-24 23:08:11Z ottenhoff@longsight.com $
 ***********************************************************************************
 *
...
public class CreatorPartStructure implements org.osid.repository.PartStructure
{
	...
	private String description = "Examples of a Creator include a person, an " +
	...
	private static CreatorPartStructure creatorPartStructure;
	
	private CreatorPartStructure()
	{
		try {
	...
	protected static synchronized CreatorPartStructure getInstance()
	{
		if( creatorPartStructure == null ) {
			creatorPartStructure = new CreatorPartStructure();
		}
