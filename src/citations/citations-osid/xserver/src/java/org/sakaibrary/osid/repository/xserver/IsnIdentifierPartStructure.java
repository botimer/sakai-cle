/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/citations/trunk/citations-osid/xserver/src/java/org/sakaibrary/osid/repository/xserver/IsnIdentifierPartStructure.java $
 * $Id: IsnIdentifierPartStructure.java 105079 2012-02-24 23:08:11Z ottenhoff@longsight.com $
 ***********************************************************************************
 *
...
implements org.osid.repository.PartStructure
{
    ...
    private IsnIdentifierPartStructure()
    {
        try
        {
            this.ISN_IDENTIFIER_PART_STRUCTURE_ID = Managers.getIdManager().getId(
            		"d7345qe3245a1006esr98n1234bvh8730");
        }
        catch (Throwable t)
        {
